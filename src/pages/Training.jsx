  ...
  const courses = [
    {
      ...
      students: 234,
      rating: 4.8,
      image: "/desarrollo-front-end.png",
      icon: Layout
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Desarrolla las habilidades más demandadas en el mercado con nuestros programas de formación intensiva.
            </p>
          </div>

          <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-50 p-6 rounded-xl text-center group hover:bg-white hover:shadow-md transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <div key={index} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all overflow-hidden group">
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm ${
                      index % 2 === 0 ? 'bg-primary/90 text-white' : 'bg-secondary/90 text-white'
                    }`}>
                      {course.category}
                    </span>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500 flex items-center gap-1">
                      <Users className="h-4 w-4" /> {course.students} estudiantes
                    </span>
            ...
            {pathways.map((pathway, index) => (
              <div key={index} className="relative group">
                ...
                <div className="relative bg-white p-6 rounded-xl">
                  ...
                  <button className="mt-4 w-full py-2 bg-gray-50 text-gray-900 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center gap-2">
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Metodología Probada</h3>
                    <p className="text-white/80">Aprende con un sistema diseñado para maximizar tu retención</p>
                  </div>
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/20 mb-4">
                    ...
                    <p className="text-white/80">Aprende de profesionales con experiencia en la industria</p>
                  </div>
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/20 mb-4">
                      <Award className="h-6 w-6" />
                    </div>
                    <h3 className="text-xl font-semibold mb-2">Certificación Reconocida</h3>
                    <p className="text-white/80">Obtén certificados validados por empresas líderes</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Transforma tu carrera con nuestros programas de capacitación especializados.
          </p>
